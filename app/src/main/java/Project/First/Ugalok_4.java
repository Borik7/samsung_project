...
public class Ugalok_4 extends AppCompatActivity {
    ImageView ktor1;
    ImageView ktor2;
    ImageView ktor3;
    ImageView ktor4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ugalok4);
        ViewPager viewPager = findViewById(R.id.viewPager);
        ImageAdapterUgalok4 adapterugol4 = new ImageAdapterUgalok4(this);
        viewPager.setAdapter(adapterugol4);
