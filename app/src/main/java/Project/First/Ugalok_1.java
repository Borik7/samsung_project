...
public class Ugalok_1 extends AppCompatActivity {
    ImageView ktor1;
    ImageView ktor2;
    ImageView ktor3;
    ImageView ktor4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ugalok1);
        ViewPager viewPager = findViewById(R.id.viewPager);
        ImageAdapterUgalok1 adapterugol1 = new ImageAdapterUgalok1(this);
        viewPager.setAdapter(adapterugol1);
